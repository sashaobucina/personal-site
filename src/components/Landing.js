          ...
          <MDBContainer fluid>
            <MDBRow>
              <MDBCol className="offset-sm-0 offset-md-0" md="12" sm="12">
                <h1 className="font-weight-bold">Sasha Obucina</h1>
                <h2 className="mt-1">Software Developer</h2>
              </MDBCol>
            </MDBRow>
            <MDBRow className="landing-btn-group mt-5">
              ...
              <MDBCol md="4" sm="3">
                <MDBBtn
                  href="https://www.linkedin.com/in/sasha-obucina/"
                  color="indigo"
                >
                  Linkedin
                  <MDBIcon className="ml-1" fab icon="linkedin"></MDBIcon>
                </MDBBtn>
              </MDBCol>
